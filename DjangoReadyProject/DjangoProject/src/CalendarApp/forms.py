...
class RegisterForm(forms.Form):
    Login = forms.CharField(widget=forms.TextInput(attrs={ 'required': 'true', 'autofocus': 'true','placeholder': 'Username', 'class':'form-control' }), min_length=6,max_length=50, required= True, label= 'Login:',
                            error_messages={'required': 'You need to set you Login', 'max_length':'Login is to long - max 50 characters', 'min_length': 'You login is too short - at least 6 characters'})
